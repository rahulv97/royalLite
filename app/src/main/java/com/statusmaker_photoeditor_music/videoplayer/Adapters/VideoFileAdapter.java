...
public class VideoFileAdapter extends RecyclerView.Adapter<VideoFileAdapter.ViewHolder> {
    ...
    public VideoFileAdapter(ArrayList<String> applications_list, String folder_name, String status, Context context, VideoDeleteInterface videoDeleteInterface){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.video_thumb_item_view, parent, false);
    ...
    public void onBindViewHolder(@NonNull VideoFileAdapter.ViewHolder holder, int position) {
        ...
        holder.thumb_rel.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
