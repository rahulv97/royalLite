...
public class VideoFolderAdapter extends RecyclerView.Adapter<VideoFolderAdapter.ViewHolder> {
    ...
    public VideoFolderAdapter(ArrayList<String> applications_list, ArrayList<String> status, String list_layout, Context context, VideoListInterface videoListInterface){
