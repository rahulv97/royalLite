...
public class FastScrollRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener {
    ...
    private com.statusmaker_photoeditor_music.videoplayer.music_player.addon.fastscrollrecyclerview.OnFastScrollStateChangeListener mStateChangeListener;
    ...
    protected void updateThumbPosition(ScrollPositionState scrollPosState, int rowCount, int yOffset) {
        ...
        int scrollBarX;
        if (com.statusmaker_photoeditor_music.videoplayer.music_player.addon.fastscrollrecyclerview.Utils.isRtl(getResources())) {
            scrollBarX = 0;
        } else {
    ...
    public void setStateChangeListener(com.statusmaker_photoeditor_music.videoplayer.music_player.addon.fastscrollrecyclerview.OnFastScrollStateChangeListener stateChangeListener) {
