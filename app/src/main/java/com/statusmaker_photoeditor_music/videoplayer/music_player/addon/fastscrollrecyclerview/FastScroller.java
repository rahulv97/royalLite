...
public class FastScroller {
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        mThumbHeight = com.statusmaker_photoeditor_music.videoplayer.music_player.addon.fastscrollrecyclerview.Utils.toPixels(resources, 48);
        mWidth = com.statusmaker_photoeditor_music.videoplayer.music_player.addon.fastscrollrecyclerview.Utils.toPixels(resources, 8);

        mTouchInset = com.statusmaker_photoeditor_music.videoplayer.music_player.addon.fastscrollrecyclerview.Utils.toPixels(resources, -24);
        ...
        try {
            ...
            int popupTextSize = typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollPopupTextSize, com.statusmaker_photoeditor_music.videoplayer.music_player.addon.fastscrollrecyclerview.Utils.toScreenPixels(resources, 56));
            int popupBackgroundSize = typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollPopupBackgroundSize, com.statusmaker_photoeditor_music.videoplayer.music_player.addon.fastscrollrecyclerview.Utils.toPixels(resources, 88));
    ...
    public void handleTouchEvent(MotionEvent ev, int downX, int downY, int lastY,
                                 com.statusmaker_photoeditor_music.videoplayer.music_player.addon.fastscrollrecyclerview.OnFastScrollStateChangeListener stateChangeListener) {
