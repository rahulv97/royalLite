package com.statusmaker_photoeditor_music.videoplayer.music_player.ui.widget.avsb;
...
import com.statusmaker_photoeditor_music.videoplayer.music_player.interactors.AppExecutors;
...
class VisualSeekBarParser implements ProgressListener {
    ...
    protected com.statusmaker_photoeditor_music.videoplayer.music_player.ui.widget.soundfile.SoundFile mSoundFile;
    ...
    void parse(Song song) {
        AppExecutors.getInstance().networkIO().execute(() -> {
                    ...
                    try {
                        mSoundFile = com.statusmaker_photoeditor_music.videoplayer.music_player.ui.widget.soundfile.SoundFile.create(song, this);
                        //Thread.sleep(2500);
