...
import com.statusmaker_photoeditor_music.videoplayer.statussaver.util.ClipboardListener;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.rvAbout) {
            i = new Intent(activity, AboutUsActivity.class);
            startActivity(i);
        } else if (id == R.id.rvShareApp) {
            Utils.ShareApp(activity);
        } else if (id == R.id.rvRateApp) {
            Utils.RateApp(activity);
        } else if (id == R.id.rvMoreApp) {
